...
//                  drawCard(d,p1,fptr);
//              }
//              else if(sayCard(p2, fptr, checkCard)) {
//                  Card giveCard = p2.removeCardFromHand(checkCard);
//                  p1.bookCards(checkCard,giveCard);
//                  giveCard = p1.removeCardFromHand(checkCard);
//                  bookCard(p1, giveCard, fptr);
//                  fptr << endl;
//                  cout << endl;
//              }
//              else {
...
//                 Card giveCard = p1.removeCardFromHand(checkCard);
//                 p2.bookCards(checkCard, giveCard);
//                 giveCard = p2.removeCardFromHand(checkCard);
//                 bookCard(p2, giveCard, fptr);
//                 fptr << endl;
//                 cout << endl;
//             }
//             else {
